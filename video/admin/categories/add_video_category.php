...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO videocategory (categoryname, categorydescription, accesslevel, createdbyID, createddatetime, statusID, regionID) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<!-- InstanceBeginEditable name="doctitle" --><title><?php $pageTitle = "Add Video Category"; echo $site_name." ".$admin_name." - ".$pageTitle; ?></title><!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
   ...
   <h1><i class="glyphicon glyphicon-film"></i> Add Video Category </h1>
   
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
     <table class="form-table"> <tr>
         <td class="text-nowrap text-right">Category name:</td>
         <td><input name="categoryname" type="text"  value="" size="32" /></td>
       </tr> <tr>
...
do {  
?>
             <option value="<?php echo $row_rsAccessLevel['ID']?>"><?php echo $row_rsAccessLevel['usertype']?></option>
             <?php
