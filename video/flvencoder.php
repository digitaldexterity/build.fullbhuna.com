...
<title><?php $pageTitle = "FLV encoder"; echo $site_name." - ".$pageTitle; ?></title>
<!-- InstanceEndEditable -->
...
<body class="bootstrap <?php echo $body_class;  ?>">
	<?php require_once('../local/includes/header.inc.php'); ?>
      ...
      <!-- ISEARCH_BEGIN_INDEX -->
      <!-- InstanceBeginEditable name="Body" --><!---------Begin FLV Encoder code ---------------->
<script src="//www.flvencoder.com/iframed/box.php">
</script>
