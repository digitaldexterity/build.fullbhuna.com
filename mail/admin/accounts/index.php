...
$query_rsAccounts = "SELECT ID, accountname, mailserver, statusID FROM mailaccount WHERE regionID = ".intval($regionID);
...
<title>
<?php $pageTitle = "Manage Mail Accounts"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
 ...
 <h1><i class="glyphicon glyphicon-envelope"></i> Manage Mail Accounts</h1>
    <nav class="navbar navbar-default navbar-expand-lg navbar-light bg-light"><div class="container-fluid"><ul class="nav navbar-nav">
      <li class="nav-item"><a href="add_account.php" class="nav-link"><i class="glyphicon glyphicon-plus-sign"></i> Add Account</a></li>
    ...
    <?php if ($totalRows_rsAccounts == 0) { // Show if recordset empty ?>
      <p>You can add you rown POP email acccounts to receive your mail here on the system. This will not affect email to your normal emai client.</p>
  ...
  <thead>
    ...
    <?php do { ?>
      ...
      <td class="status<?php echo $row_rsAccounts['statusID']; ?>">&nbsp;</td>
        ...
        <td><?php echo $row_rsAccounts['mailserver']; ?></td>
