...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO communicationcategory (categoryname, createdbyID, createddatetime) VALUES (%s, %s, %s)",
...
<title>
<?php $pageTitle = "Add Category"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <!-- InstanceBeginEditable name="Body" -->
        <div class="page mail">
    <h1><i class="glyphicon glyphicon-envelope"></i> Add Category</h1>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table class="form-table"> <tr>
            <td class="text-nowrap text-right">Category name:</td>
            <td><input name="categoryname" type="text" value="" size="20" maxlength="20"  class="form-control"/></td>
        </tr> <tr>
