...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE communicationcategory SET categoryname=%s, modifiedbyID=%s, modifieddatetime=%s, statusID=%s WHERE ID=%s",
...
mysql_select_db($database_aquiescedb, $aquiescedb);
$query_rsCategory = sprintf("SELECT * FROM communicationcategory WHERE ID = %s", GetSQLValueString($colname_rsCategory, "int"));
...
<title>
<?php $pageTitle = "Update Category"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <!-- InstanceBeginEditable name="Body" -->
        <div class="page mail">
    <h1><i class="glyphicon glyphicon-envelope"></i> Update Category</h1>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table class="form-table"> <tr>
            <td class="text-nowrap text-right">Category name:</td>
            <td><input name="categoryname" type="text" value="<?php echo $row_rsCategory['categoryname']; ?>" size="20" maxlength="20"  class="form-control"/></td>
        </tr> <tr>
            <td class="text-nowrap text-right"> <label for="statusID">Active:</label></td>
            <td><input type="checkbox" name="statusID" id="statusID" />
           </td>
        </tr> <tr>
