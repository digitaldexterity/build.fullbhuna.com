...
$update = "UPDATE users SET emailoptin = 0 WHERE email = ".GetSQLValueString($_GET['email'],"text");
...
<title><?php  $pageTitle = "Unsubscribe conformation"; echo $pageTitle." | ".$site_name;?></title>
<!-- InstanceEndEditable -->
...
<body class="bootstrap <?php echo $body_class;  ?>">
    ...
    <p>If you are a member of our site, you can always return to our mailing list by <a href="../members/profile/update_profile.php">updating your profile.</a></p>
