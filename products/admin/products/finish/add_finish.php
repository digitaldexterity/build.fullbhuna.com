...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO productfinish (finishname, createdbyID, createddatetime, imageURL) VALUES (%s, %s, %s, %s)",
...
<title><?php $pageTitle = "Add Colour/Finish"; echo $site_name." ".$admin_name." - ".$pageTitle; ?></title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <h1><i class="glyphicon glyphicon-shopping-cart"></i> Add  Colour/Finish</h1>
    <p>&nbsp;</p>
    <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table class="form-table"> <tr>
          <td class="text-nowrap text-right">Finish name:</td>
          <td><span id="sprytextfield1">
            <input name="finishname" type="text" value="" size="50" maxlength="50" class="form-control" />
          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr  class="upload">
          <td class="text-nowrap text-right"><label for="filename">Image (optional):</label></td>
          <td>
          ...
          <td><div><button type="submit" class="btn btn-primary" >Add finish</button></div></td>
        </tr>
      </table>
