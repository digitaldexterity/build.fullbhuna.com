...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO productshippingzone (zonename, type, bypostcode, createdbyID, createddatetime) VALUES (%s, %s, %s, %s, %s)",
...
<title>
<?php $pageTitle = "Add Shipping Zone"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <h1><i class="glyphicon glyphicon-shopping-cart"></i> Add Shipping Zone</h1>
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table class="form-table"> <tr>
          <td class="text-nowrap text-right">Zone name:</td>
          <td><span id="sprytextfield1">
            <input name="zonename" type="text" value="" size="50" maxlength="100" class="form-control" />
          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr> <tr>
          <td class="text-nowrap text-right">Type:</td>
          <td><span id="spryradio1"><label><input type="radio" name="type" value="1" />
            
           
               National</label>&nbsp;&nbsp;<label><input type="radio" name="type" value="2" />
                International</label></span> </td>
        </tr> <tr>
          <td class="text-nowrap text-right">By postcode:</td>
          <td><span id="sprytextfield2">
            <input name="bypostcode" type="text"  class="form-control" size="50" />
</span></td>
        </tr> <tr>
          <td class="text-nowrap text-right">&nbsp;</td>
          <td><button type="submit" class="btn btn-primary" >Add zone</button></td>
        </tr>
      </table>
