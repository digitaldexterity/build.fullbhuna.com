...
//$strConnectTo= (isset($_SESSION['MM_UserGroup']) && $_SESSION['MM_UserGroup']==10) ? "TEST" : "LIVE"; 	//Set to SIMULATOR for the Sage

$strConnectTo="LIVE";

/** 
 Pay Simulator expert 

//$strConnectTo= ($prefs['shopstatus'] ==1) ? "LIVE" : "TEST"; system, TEST for the Test Server **
							*** and LIVE in the live environment **/

$strDatabaseUser=$username_aquiescedb; // Change this if you created a different user name to access the database
$strDatabasePassword=$password_aquiescedb; // Set the password for the above user here
$strDatabase=$database_aquiescedb; // Change this if you created a different database name

$strVirtualDir="products/payments/sagepay"; // Change if you've created a Virtual Directory in IIS with a different name
...
$strYourSiteFQDN= getProtocol()."://". $_SERVER['HTTP_HOST']."/";
...
$strYourSiteInternalFQDN= getProtocol()."://".$_SERVER['HTTP_HOST']."/"; 


$strVendorName=$prefs['paymentclientID']; // Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied
...
mysql_connect($hostname_aquiescedb,$strDatabaseUser,$strDatabasePassword); //Change 'localhost' if your database is hosted externally
