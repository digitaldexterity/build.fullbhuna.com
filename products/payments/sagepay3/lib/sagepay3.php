 ...
 */
if(!defined("SAGEPAY_CRYPT_PASSWORD")) die("PLEASE DEFINE CRYPT PASSWORD");
...
class SagePay {
	...
	protected $language;
	protected $website;
	protected $encryptPassword = SAGEPAY_CRYPT_PASSWORD;
	...
	protected function encryptAndEncode($strIn) {
		...
		if(function_exists("mcrypt_encrypt")) {
			...
			return "@".strtoupper(bin2hex(openssl_encrypt( $strIn, 'AES-128-CBC', $this->encryptPassword, OPENSSL_RAW_DATA, $this->encryptPassword)));
		}
	}
