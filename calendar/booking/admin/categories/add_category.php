...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bookingcategory (`description`, createdbyID, createddatetime, statusID) VALUES (%s, %s, %s, %s)",
...
<!-- InstanceBeginEditable name="doctitle" --><title><?php $pageTitle = "Add Booking Category"; echo $site_name." ".$admin_name." - ".$pageTitle; ?></title><!-- InstanceEndEditable -->
...
<main>
  ...
  <table class="form-table"> <tr>
         ...
         <td><input name="description" type="text"  value="" size="60" maxlength="100" /></td>
       </tr> <tr>
