...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO eventcategorygroup (groupname, groupdescription, createdbyID, createddatetime, statusID) VALUES (%s, %s, %s, %s, %s)",
...
<title><?php $pageTitle = "Add Category Group"; echo $site_name." ".$admin_name." - ".$pageTitle; ?></title>
<!-- InstanceEndEditable -->
...
<main>
  ...
  <h1><i class="glyphicon glyphicon-calendar"></i> Add Category Group</h1>
