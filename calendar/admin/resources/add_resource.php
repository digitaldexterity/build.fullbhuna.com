...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO eventresource (resourcename, `description`, statusID, createdbyID, createddatetime, categoryID) VALUES (%s, %s, %s, %s, %s, %s)",
...
<title>
<?php $pageTitle = "Add Resource"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <!-- InstanceBeginEditable name="Body" --><div class="page calendar"><h1><i class="glyphicon glyphicon-calendar"></i> Add Resource</h1>
            ...
            <table class="form-table" >
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <input name="resourcename" type="text" value="" size="50" maxlength="50">
