...
$query_rsQuestion = sprintf("SELECT question_number, questiontext FROM survey_question WHERE ID = %s", GetSQLValueString($colname_rsQuestion, "int"));
...
<title>
<?php $pageTitle = "Multi-text answers"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <h1><i class="glyphicon glyphicon-education"></i> Multi-text answers</h1>
    <h2><?php echo $row_rsQuestion['question_number']; ?>. <?php echo $row_rsQuestion['questiontext']; ?></h2>
    <table border="0" cellpadding="0" cellspacing="0" class="form-table">
      
      <?php do { ?>
        <h3><?php echo $row_rsAnswers['answertext']; ?></h3><ul>
        <?php $select = "SELECT response FROM survey_response_multitext WHERE answerID = ".$row_rsAnswers['ID']; 
		$result = mysql_query($select, $aquiescedb) or die(mysql_error());
 		while($row = mysql_fetch_assoc($result)) { ?>
        <li><?php echo $row['response']; ?></li>
 		<?php }	?>
        </ul>
