...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO userrelationshiptype (relationshiptype, createdbyID, createddatetime, regionID, accessID) VALUES (%s, %s, %s, %s, %s)",
...
<title>
<?php $pageTitle = "Add Relationship Type"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <!-- InstanceBeginEditable name="Body" -->
        <h1><i class="glyphicon glyphicon-user"></i> Add Relationship Type</h1>
      
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1">
          <table class="form-table" > <tr>
              <td class="text-nowrap text-right top">Relationship type:</td>
              <td><span id="sprytextfield1">
                <input name="relationshiptype" type="text" value="" size="50" maxlength="100" class="form-control">
...
?>
              ...
              <td><button type="submit" class="btn btn-primary" >Add Relationship Type</button></td>
            </tr>
          </table>
