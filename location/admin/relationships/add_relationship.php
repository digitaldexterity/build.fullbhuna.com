...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO locationuserrelationship (relationship, createdbyID, createddatetime) VALUES (%s, %s, %s)",
...
<title>
<?php $pageTitle = "Add Relationship"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
...
<main>
  <div class="container clearfix">
    ...
    <!-- InstanceBeginEditable name="Body" --><div class="page location">
      <h1><i class="glyphicon glyphicon-flag"></i> Add Relationship</h1>
      
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1">
        <table align="left" class="form-table"> <tr>
            <td class="text-nowrap text-right top">Relationship:</td>
            <td><span id="sprytextfield1">
              <input name="relationship" type="text" value="" size="50" maxlength="50">
