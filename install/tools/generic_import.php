<?php require_once('../upgrade/Connections/aquiescedb.php'); ?>
<?php require_once('../upgrade/core/includes/adminAccess.inc.php'); ?>
<?php require_once('../upgrade/core/includes/upload.inc.php'); ?>
<?php require_once('../upgrade/members/includes/userfunctions.inc.php'); ?>
<?php require_once('../upgrade/directory/includes/directoryfunctions.inc.php'); ?>
<?php require_once('../upgrade/location/includes/locationfunctions.inc.php'); ?>
<?php require_once('../upgrade/core/includes/framework.inc.php'); ?>
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
<title>
<?php $pageTitle = "Generic Import"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <div class="page class">
      <h1>Import</h1>
       <?php require_once('../upgrade/core/includes/alert.inc.php'); ?>
      ...
      <p>
        <label>1. Get your data ready in the form of a CSV file and select:
          ...
          <p>
        <label>Table name:
          <input type="text" name="table" id="table" class="form-control" value="<?php echo (isset($_POST['table'])) ? htmlentities($_POST['table'], ENT_COMPAT, "UTF-8") : ""; ?>">
        </label>
        </p>
      <p>
