...
$query_rsImages = "SELECT imageuRL, 'user' AS type  FROM users WHERE imageURL IS NOT NULL UNION SELECT imageuRL, 'product' AS type  FROM product WHERE imageURL IS NOT NULL UNION SELECT imageuRL, 'photo' AS type  FROM photos WHERE imageURL IS NOT NULL ";
...
<h1>Image Audit (Under Construction)</h1>
<p>Find images that are not being used and delete to save server space. NOTE: This is not a comprehensive test and only main imkages are shown.</p>
