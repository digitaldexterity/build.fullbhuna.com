...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO photocategories (categoryname, `description`, accesslevel, addedbyID, createddatetime, groupID, regionID) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
$insertGoTo = "/photos/gallery/index.php?galleryID=".$galleryID;
  if (isset($_SERVER['QUERY_STRING'])) {
...
<body class="bootstrap <?php echo $body_class;  ?>">
	<?php require_once('../../../local/includes/header.inc.php'); ?>
      ...
      <!-- ISEARCH_BEGIN_INDEX -->
      <!-- InstanceBeginEditable name="Body" --><div class="container pageBody addphotogallery">
          <h1>Add Gallery<?php echo isset($row_rsThisDirectory['name']) ? " for ".$row_rsThisDirectory['name'] : ""; ?></h1>
            ...
            <table  class="form-table">
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <input name="categoryname" type="text"  id="categoryname" size="50" maxlength="50" value="<?php echo isset($_REQUEST['categoryname']) ? htmlentities($_REQUEST['categoryname']) : $row_rsThisDirectory['name']; ?>" />
...
?>
              ...
              <tr>
                ...
                <td><textarea name="description" cols="50" rows="5" id="description"><?php echo isset($_REQUEST['description']) ? htmlentities($_REQUEST['description']) : ""; ?></textarea></td>
              </tr>
              <tr>
