...
if(isset($_GET['directoryID'])) {
	addUserToDirectory($row_rsLoggedIn['ID'], $_GET['directoryID'], $row_rsLoggedIn['ID']);
}
?>
...
<title>
<?php $pageTitle = "Welcome to ".$row_rsThisDirectory['name']; echo $pageTitle." | ".$site_name; ?>
</title>
<!-- InstanceEndEditable -->
...
<body class="bootstrap <?php echo $body_class;  ?>">
    ...
    <h1>Welcome to <?php echo $row_rsThisDirectory['name']; ?></h1>
<p>Go to your <a href="/members/">members page</a></p>
  <!-- InstanceEndEditable -->
    </main>
    <!-- ISEARCH_END_INDEX --> 
