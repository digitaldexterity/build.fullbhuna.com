...
$query_rsLoggedIn = sprintf("SELECT ID, firstname, termsagree, changepassword, users.lastlogin FROM users WHERE username = %s", GetSQLValueString($colname_rsLoggedIn, "text"));
...
<link href="../css/newsDefault.css" rel="stylesheet" >
<style >
<!--
...
<body class="bootstrap <?php echo $body_class;  ?>">
 ...
 <div id="newsfeed" >
 <h1>Good <?php if (date('H') <12) echo "morning"; else  if (date('H') <17) echo "afternoon"; else echo "evening"; echo ", ".$row_rsLoggedIn['firstname']; ?>...</h1><h2><?php echo date('l jS F'); ?></h2>
   <?php require_once('newsfeed.inc.php'); ?>  
