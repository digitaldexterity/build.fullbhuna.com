...
// PE - altered below to allow for absolute path
var loc = scriptFiles[scriptFiles.length - 1].src.substr(0, scriptFiles[scriptFiles.length - 1].src.lastIndexOf("/"));
loc += (loc=="") ? "/core/scripts/date-picker/js/" : "/";
loc += "lang/" + datePicker.languageinfo + ".js";
