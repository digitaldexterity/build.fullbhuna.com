<?php //random_image_sample.php contents
...
function random_string($len=5, $str='')
{
  for($i=1; $i<=$len; $i++)
   {
    //generates a random number that will be the ASCII code of the character. We only want  lower case letters. 
    $ord=rand(97, 122);
    $str.=chr($ord);
...
$font1 = "../fonts/".rand(10, 10).".ttf";
$font2 = "../fonts/".rand(10, 10).".ttf";
$font3 = "../fonts/".rand(10, 10).".ttf";
$font4 = "../fonts/".rand(10, 10).".ttf";
$font5 = "../fonts/".rand(10, 10).".ttf";// normally rand(1,10)
