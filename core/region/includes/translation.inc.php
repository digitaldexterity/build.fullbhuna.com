<?php // Copyright 2009 Paul Egan ?><?php require_once(SITE_ROOT.'core/includes/framework.inc.php'); ?>
<?php if(is_readable(SITE_ROOT."/core/region/translate.php")) {
	$transurl = getProtocol()."://";
	$transurl = urlencode($transurl.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); ?>

<div class="translation">
  <form action="/core/region/translate.php" method="get" class="form-inline">
    <select name="translate" id="translate" onchange="this.form.submit();" class="form-control">
