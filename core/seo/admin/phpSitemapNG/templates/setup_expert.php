...
if (!isset($SETTINGS[PSNG_COMPRESS_SITEMAP])) $SETTINGS[PSNG_COMPRESS_SITEMAP] = '';
	...
	<table border="0" cellpadding="5" cellspacing="0" width="495">
	  ...
	  <tr>
	  	<td class="top"><label for="iwebsite" accesskey="W">Website</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="iping" accesskey="W">Ping google</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="iping" accesskey="W">Compress sitemap</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="itimeout" accesskey="O" title="stop the execution after an amount of time">Timeout</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="iscan_local" accesskey="C">Scan</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="iedit_result" accesskey="E">Display edit screen after scan</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="istore_filelist" accesskey="B">Store filelist</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="idisallow_dir" accesskey="D">Exclude directories</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="idisallow_file" accesskey="F">Exclude files</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="idisallow_key" accesskey="K">Exclude url keys</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="isitemap_url" accesskey="S">Sitemap file</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="itxtsitemap_url" accesskey="S">TXT Sitemap file</label><br /><font size="-1">Used by Yahoo, ...</font></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="ilastmod" accesskey="L">Lastmod</label></td>
		<td>
		  <p>
	  ...
	  <tr>
	  	<td class="top"><label for="ipriority" accesskey="P">Priority</label></td>
		<td>
	  ...
	  <tr>
	  	<td class="top"><label for="ichangefreq" accesskey="C">Changefreq</label></td>
		<td>
