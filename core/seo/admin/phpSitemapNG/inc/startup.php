...
$settingsfile = 'settings/settings'.$regionID.'.inc.php';
$filesfile = 'settings/files'.$regionID.'.inc.php';
if(!is_readable($settingsfile)) {
	copy ( 'settings/settings.inc.php' , $settingsfile); 
	chmod($settingsfile,fileperms('settings/settings.inc.php')) or die("Couldn't CHMOD");
	copy ( 'settings/files.inc.php' , $filesfile); 
	chmod($filesfile,fileperms('settings/files.inc.php')) or die("Couldn't CHMOD");
}

$SETTINGS[PSNG_FILE_SETTINGS] = 	$settingsfile; // 'settings/settings.inc.php';
$SETTINGS[PSNG_FILE_FILES] = 		$filesfile; // 'settings/files.inc.php';
