...
/*
	...
	// send via cURL instead of URL fopen which is not supported on many server
        $ch = curl_init(); 
        curl_setopt($ch, CURLOPT_URL, "http://www.google.com/webmasters/sitemaps/ping?sitemap=".urlencode($SETTINGS['website'].$SETTINGS[PSNG_SITEMAP_URL])); 
