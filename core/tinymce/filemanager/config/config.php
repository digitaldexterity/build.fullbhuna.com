...
/* CHANGES BY PAUL EGAN */

if(!isset($_SESSION['MM_UserGroup']) || $_SESSION['MM_UserGroup']<1 ) die("No access");
...
// added swf
'ext_video'  => array( 'mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm", "swf" ),

'MaxSizeUpload' => 100,

*/

/* END OF CHANGES BY PAUL EGAN */
...
$config = array(
    ...
    */
    ...
    'jplayer_exts'                            => array("mp4","flv","webmv","webma","webm","m4a","m4v","ogv","oga","mp3","midi","mid","ogg","wav", "swf" ),
