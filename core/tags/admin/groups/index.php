...
mysql_select_db($database_aquiescedb, $aquiescedb);
$query_rsTagGroups = "SELECT * FROM taggroup ORDER BY ordernum ASC";
...
<title>
<?php $pageTitle = "Manage Tag Groups"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <div class="page class">
      ...
      <nav class="navbar navbar-default navbar-expand-lg navbar-light bg-light"><div class="container-fluid"><ul class="nav navbar-nav"><li class="nav-item"><a href="add_tag_group.php" class="nav-link"><i class="glyphicon glyphicon-plus-sign"></i> Add Tag Group</a></li>
      <li class="nav-item"><a href="../index.php" class="nav-link"><i class="glyphicon glyphicon-arrow-left"></i> Back to Tags</a></li></ul></div></nav>
      <?php if ($totalRows_rsTagGroups > 0) { // Show if recordset not empty ?>
  <p class="text-muted">Tag Groups <?php echo ($startRow_rsTagGroups + 1) ?> to <?php echo min($startRow_rsTagGroups + $maxRows_rsTagGroups, $totalRows_rsTagGroups) ?> of <?php echo $totalRows_rsTagGroups ?> </p>
        ...
        <thead>
          ...
          <?php do { ?>
            <tr>
              ...
              <td><?php echo $row_rsTagGroups['regionID']; ?></td>
            ...
            <?php } while ($row_rsTagGroups = mysql_fetch_assoc($rsTagGroups)); ?></tbody>
        </table>
