...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO font (fontname, fontcssURL, createdbyID, createddatetime) VALUES (%s, %s, %s, %s)",
      ...
      <table class="form-table">
        <tbody>
          <tr>
            ...
            <td>
              <input name="fontname" type="text" id="fontname" size="50" maxlength="150" class="form-control"></td>
          </tr>
          <tr>
            <td class="text-right"><label for="fontcssURL">CSS URL:</label></td>
            <td>
              <input name="fontcssURL" type="text" id="fontcssURL" size="50" maxlength="255"  class="form-control"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><button type="submit" class="btn btn-primary" >Add Font</button>
