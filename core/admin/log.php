...
writeLog("Log viewed by ".$_SESSION['MM_Username']); 
if (!isset($_SESSION)) {
  session_start();
}
...
$msg = "Debug is ";
$msg .= isset($_SESSION['debug']) ? "on." : "off."
?>
<!doctype html>
...
<title>
<?php $pageTitle = "Full Bhuna Log"; echo $site_name." ".$admin_name." - ".$pageTitle; ?>
</title>
<!-- InstanceEndEditable -->
...
<main>
  <div class="container clearfix">
    ...
    <div class="page class">
      ...
      </nav><?php require_once('../includes/alert.inc.php'); ?>
<pre><?php echo  getLog(); 
