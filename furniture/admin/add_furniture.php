...
<?php require_once('../../core/includes/upload.inc.php'); ?><?php require_once('../../articles/includes/functions.inc.php'); ?>
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO furniture (furniturename, furnituretext, furniturelink, appearsonURL, newwindow, imageURL, width_px, height_px, createdbyID, createddatetime, statusID, regionID) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title><?php $pageTitle = "Add Furniture"; echo $site_name." ".$admin_name." - ".$pageTitle; ?></title>
<!-- InstanceEndEditable -->
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
    <table class="form-table"> <tr>
        ...
        <td><span id="sprytextfield1">
          <input name="furniturename" type="text"  value="" size="50" maxlength="50" class="form-control" />
          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
      </tr> <tr>
        <td class="text-nowrap text-right top">Text:</td>
        <td><span id="sprytextarea1">
          <textarea name="furnituretext" cols="50" rows="5" class="form-control" ></textarea>
</span></td>
      </tr> <tr>
        <td class="text-nowrap text-right">Link:</td>
        <td>
          <select name="linkmenu" id="linkmenu" onChange="document.getElementById('furniturelink').value = this.value" class="form-control" >
...
?>
          ...
          <input name="furniturelink" id="furniturelink" type="text"  value="" size="50" maxlength="100" class="form-control" />
</td>
      </tr> <tr>
...
?>
        ...
        <td class="text-nowrap text-right">ImageURL:</td>
        <td><input type="hidden" name="imageURL" value="" />
          <label>
        ...
        <td><label>
          ...
          Auto detect</label><br /><span id="imagesize" class="form-inline">Width:
          <input name="width_px" id="width_px" type="text"  value="" size="4" maxlength="4" class="form-control"  />
          pixels Height:
            <input name="height_px" id="height_px" type="text"  value="" size="4" maxlength="4" class="form-control" /> 
            pixels</span></td>
      </tr> <tr>
        <td class="text-nowrap text-right">&nbsp;</td>
        <td><button type="submit" class="btn btn-primary">Add page furniture</button></td>
      </tr>
    </table>
